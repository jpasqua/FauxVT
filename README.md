...
* **Audio**: Add an internal audio amp and speaker. Currently you can [set up an external bluetooth speaker or headphones](https://raspberrydiy.com/connect-raspberry-pi-bluetooth-speaker/) to get sound. In the future I may add an internal audio amp and speaker.
...
* **Keyboard LEDs**: [Lars Brinkhoff](https://github.com/larsbrinkhoff/) recommends adding LEDs to the keyboard. 
